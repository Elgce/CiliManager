...
import Breadcrumb from "../../BreadCrumb.vue"
    export default{
        ...
        data(){
            return{
                // Users:reactive({"admin":{"uname":"admin", "passwd":"1234"}}),
                password: ref(''),
                uname: ref(''),
        ...
        methods:{
            checklogin(){
                ...
                if (this.authority == 0){
                    this.$router.push("/index/activities");
                }
                    ...
                    this.$router.push("/index/activities/learn");
                }
                else if (this.authority == 4){
                    this.$router.push("/index/activities/charity");
                }
                else if (this.authority == -1){
                    ElMessage({
                        message: 'Error:You have input wrong uname or passwd!',
                        type: 'warning',
                        grouping: true,
                    });
                }
