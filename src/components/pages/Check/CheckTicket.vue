    ...
    <el-container>
        ...
        <el-main>
            <div class="login-wrap">
                ...
                <h1 class="title">优惠券核验</h1>
                <el-form-item label="优惠券验证码">
                    <el-input type="text" v-model="key" placeholder="验证码" autocomplete="off"></el-input>
                </el-form-item>
 
                <el-form-item>
                    <el-button type="primary" style="width: 100%;" @click="checkkey()">核验</el-button>
                </el-form-item>
                </el-form>
    </div>
...
import Breadcrumb from "../../BreadCrumb.vue"
    export default{
        ...
        data(){
            return{
                Users:reactive({"key1":"202001361","key2":"2020013061"}),
                key: ref(''),
            }
        },
        components:{
            ...
            checkkey(){
                ...
                .then((j)=>{
                    ...
                    if(message == 'Ok'){
                        ElNotification({
                            title: '验证成功',
                            message: '该优惠券验证码有效!  优惠券级别为:'+String(level),
                            type: 'success',
                            offset: 100,
                            duration: 10000,
                        })
                ...
                //     if (this.Users[item]==key){
                //         ElNotification({
                //             title: 'Success',
                //             message: '<span><strong>Congratulations:You have input the right key!</strong></span><span>Level:'+`\n`+String(0)+"</span>",
                //             type: 'success',
                //             offset: 100,
                ...
                //         })
                //         ElMessage({
                //             message: 'Congratulations:You have input the right key!\n'+"Level"+String(0),
                //             type: 'success',
                //             showClose: true,
                //             duration: 0,
                //             offset:150,
                ...
                // if (label == 0){
                //     ElMessage({
                //     message: 'Error:You have input wrong key! Please check it again.',
                //     type: 'warning',
                //     });
                // }
